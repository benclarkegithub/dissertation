...
from Architectures.Basic import Canvas, Encoder, EncoderEncoderToLatents4, LatentsToDecoder, Decoder
...
for trial, seed in enumerate(SEEDS):
    ...
    evaluate = Eval(method=method, experiment="CIFAR10_64_4_R_EETL4", trial=trial, seed=seed)
