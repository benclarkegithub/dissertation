...
from Architectures.Basic import Canvas, Encoder, EncoderToLatents, LatentsToLatents, LatentsToDecoder, Decoder
...
for trial, seed in enumerate(SEEDS):
    ...
    evaluate = Eval(method=method, experiment="CIFAR10_64_4_R_LTL", trial=trial, seed=seed)
