...
from Architectures.Basic import Canvas, Encoder, EncoderEncoderToEncoder, EncoderToLatents, LatentsToDecoder, Decoder
...
for trial, seed in enumerate(SEEDS):
    ...
    evaluate = Eval(method=method, experiment="CIFAR10_64_4_R_ETL", trial=trial, seed=seed)
