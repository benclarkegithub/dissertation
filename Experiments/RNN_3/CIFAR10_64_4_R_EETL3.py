...
from Architectures.Basic import Canvas, Encoder, EncoderEncoderToLatents3, LatentsToDecoder, Decoder
...
for trial, seed in enumerate(SEEDS):
    ...
    evaluate = Eval(method=method, experiment="CIFAR10_64_4_R_EETL3", trial=trial, seed=seed)
