...
method = Multiple(VAE=VAE, num_latents=NUM_LATENTS, num_latents_group=NUM_LATENTS_GROUP, variant="Original")

MAX_EPOCHS = 250
MAX_NO_IMPROVEMENT = 25

evaluate = Eval(method=method, experiment="MNIST_xs_9_3_Original", seed=SEED)
