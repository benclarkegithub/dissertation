...
from Architectures.Basic import Canvas, Encoder, EncoderEncoderToEncoder, EncoderToLatents, LatentsToLatents, LatentsToDecoder, Decoder
...
method = RNN(
    architecture=ARCHITECTURE, num_latents=NUM_LATENTS, num_latents_group=NUM_LATENTS_GROUP, variant="EncoderToLatents")

MAX_EPOCHS = 100
MAX_NO_IMPROVEMENT = 25
GET_GRAD = True

evaluate = Eval(method=method, experiment="MNIST_Basic_10_1_EncoderToLatents", seed=SEED)
