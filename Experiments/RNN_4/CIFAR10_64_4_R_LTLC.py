...
from Architectures.Basic import Canvas, Encoder, EncoderToLatents, LatentsToLatentsComplicated, LatentsToDecoder, \
    Decoder
...
for trial, seed in enumerate(SEEDS):
    ...
    evaluate = Eval(method=method, experiment="CIFAR10_64_4_R_LTLC", trial=trial, seed=seed)
