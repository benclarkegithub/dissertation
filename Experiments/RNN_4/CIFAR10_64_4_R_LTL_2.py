...
from Architectures.Basic import Canvas, Encoder, EncoderToLatents2, LatentsToLatents2, LatentsToDecoder, Decoder
...
for trial, seed in enumerate(SEEDS):
    ...
    evaluate = Eval(method=method, experiment="CIFAR10_64_4_R_LTL_2", trial=trial, seed=seed)
